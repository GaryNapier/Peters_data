...
Plot_subj <- FALSE
<<<<<<< HEAD
Analyses_nos <- c(25:29, 31:33) # NB : MUST BE > 10
=======
Analyses_nos <- c(27, 30) # NB : MUST BE > 10
>>>>>>> 0a2a817e8ca50adc4010b79d230603d47e91713f
Do_stats = TRUE
Do_plots = TRUE
...
# remove NA
=======
for (i in Analyses_nos){
  Model_names[i] <- sprintf("A%g", i)  
}
>>>>>>> 0a2a817e8ca50adc4010b79d230603d47e91713f
