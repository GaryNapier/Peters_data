...
Analyses_nos <- c(31:34) # NB : MUST BE > 10
...
for (i in 1:length(Analyses_nos)){
  ...
  grid.arrange(Sa2_box+theme(legend.position="none"), ### Sa2
               ...
               top = sprintf("Sa2, Om2, Om3, log(Nu), M2, M3, Phi2 & Phi3 posteriors; A %d", 
                             Analyses_nos[i]), 
...
grid_arrange_shared_legend(Sa2_dens, Om2_dens, Om3_dens, Nu_dens, M2_dens, M3_dens, 
                           Phi2_dens, Phi3_dens)
